                        ...
                        <div className="inline-block align-bottom bg-white dark:bg-slate-800 rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                            ...
                            <div>
                                <div className="text-center">
                                    ...
                                    <div className="mt-2">
                                        <p className="text-left text-md text-gray-500 dark:text-gray-400">
                                            Погодете го <b>ЗБОРЛЕ</b> во 6 обиди.
                                        </p>

                                        <p className="text-left text-md text-gray-500 dark:text-gray-400 mt-2">
                                            Секој обид мора да биде валиден збор од 5 букви. Притиснете го копчето ENTER
                                            да направите обид.
                                        </p>

                                        <p className="text-left text-md text-gray-500 dark:text-gray-400 mt-2 border-b-2 pb-2">
                                            По секој обид, бојата на квадратите ќе се менува да ви покаже колку вашиот
                                            обид е блиску до бараниот збор.
                                        </p>

                                        <h4 className="font-bold text-gray-900 dark:text-gray-100 mt-2">Примери</h4>
                                    ...
                                    <p className="text-left text-md text-gray-500 dark:text-gray-400 mt-2 border-t-2 pt-2">
