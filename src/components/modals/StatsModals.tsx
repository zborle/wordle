        ...
        <Transition.Root show={isOpen} as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={handleClose}>
                <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    >
                        <div
                            className="inline-block align-bottom bg-white dark:bg-slate-800 rounded-lg px-4
                        ...
                        >
                            <div className="absolute right-4 top-4">
                                <XIcon className="h-6 w-6 cursor-pointer hover:bg-slate-200 dark:hover:bg-slate-600" onClick={handleClose} />
                            </div>
                            <div>
                                <div className="text-center">
                                    <Dialog.Title
                                        as="h3"
                                        className="text-lg leading-6 font-medium text-gray-900 dark:text-gray-100 uppercase"
                                    >
                                        Статистика
                                    </Dialog.Title>
                                    <StatBar gameStats={gameStats} />
                                    <h4 className="text-lg leading-6 font-medium text-gray-900 dark:text-gray-100 uppercase">
